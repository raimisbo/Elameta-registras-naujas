...
class Detale(Timestamped):
    projektas = models.ForeignKey(Projektas, on_delete=models.CASCADE, related_name="detales", blank=True, null=True)
    pavadinimas = models.CharField(max_length=255)
...
class DetaleSpecifikacija(Timestamped):
    ...
    class Meta:
        verbose_name = "Detalės specifikacija"
        verbose_name_plural = "Detalės specifikacijos"
...
class PavirsiuDangos(Timestamped):
    ...
    class Meta:
        verbose_name = "Paviršių danga"
        verbose_name_plural = "Paviršių dangos"
...
class Kaina(Timestamped):
    ...
    detale = models.ForeignKey(Detale, on_delete=models.CASCADE, related_name="kainos", null=True, blank=True)
...
class Kainodara(Timestamped):
    ...
    class Meta:
        verbose_name = "Kainodara"
        verbose_name_plural = "Kainodaros"
...
class KainosPartijai(Timestamped):
    ...
    class Meta:
        verbose_name = "Kainos partijai"
        verbose_name_plural = "Kainos partijoms"
