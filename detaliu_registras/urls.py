...
#     path('importuoti/', views.import_csv_view, name='csv_importas'),  # importo kelias (antras variantas)
#     path('import_csv/', views.import_csv_view, name='import_csv'),  # dar vienas importo variantas (gal nereikia dviejų?)
