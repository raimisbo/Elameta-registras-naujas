...
SAMPLE = [
    dict(
        ...
        ktl_kabinimo_budas="Kablys", ktl_kabinimas_reme_txt="3-4-2",
        ktl_detaliu_kiekis_reme=24, ktl_faktinis_kiekis_reme=22,
    ...
    dict(
        ...
        ktl_kabinimo_budas="Vielutė", ktl_kabinimas_reme_txt="2-3-2",
        ktl_detaliu_kiekis_reme=18, ktl_faktinis_kiekis_reme=18,
    ...
    dict(
        ...
        ktl_kabinimo_budas="Kablys", ktl_kabinimas_reme_txt="4-4-3",
        ktl_detaliu_kiekis_reme=30, ktl_faktinis_kiekis_reme=28,
